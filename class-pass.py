...
serial_port = 'COM7'  # Replace with your actual serial port (Windows: 'COMx')
...
try:
    while True:
        ...
        if line:
            ...
            current_time = datetime.now().strftime('%Y-%m-%d %H:%M:%S')  # Full date and time

            # Write to Google Spreadsheet
            row = [name, current_time]
